function MyText(scene){
    ...
    var geometry = new THREE.TextGeometry('Ammar Dwi Anwari' , {font: font , size : 120, height : 30, material : 0, bevelThickness : 3 , extrudeMaterial : 1});
    var material = new THREE.MeshLambertMaterial({color :"#5e88c7" });
    ...
    this.update = function(time){
        ...
        if(pivot.rotation.z >= 0.5){
            isRotLeft = false;
        }else if(pivot.rotation.z <= -0.5){
            isRotLeft = true;
        }
